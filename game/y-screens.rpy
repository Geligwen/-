...
label main_menu:
    ...
    elif persistent.morrigan == 1:
        play music morrigan fadein 3.0
    else:
        play music day fadein 3.0
...
screen main_menu_screen():
    ...
    imagemap:
        if persistent.finished == 1:
            ground "main_menu_spa.png"
        elif persistent.morrigan == 1:
            ground "main_menu_morrigan.png"
        else:
            ground "main_menu.png"
        hover  "main_menu_hover.png"
        hotspot (985, 185, 230, 60) action Start()
        hotspot (985, 265, 230, 60) action ShowMenu("load")
        hotspot (985, 345, 230, 60) action ShowMenu("preferences")
        hotspot (985, 425, 230, 60) action ShowMenu("about")
        hotspot (985, 505, 230, 60) action Help()
        hotspot (985, 585, 230, 60) action Quit(confirm=False)
...
label todolist:
    if todo1st == 0:
        $ todo1st = 1
        "This is a quaint to-do list Penelope and Moxie gave me."
        "It's full of work leads, and there's plenty of room for me to erase and pencil in new plans."
        "Wow, there are a lot of options! Where should I begin?"
    call screen todolist
    screen todolist():
        imagemap:
            ground "todolist.png"
            hover "todolisthover.png"
            hotspot (980, 50, 250, 75) clicked Jump ("worldmap")
        #moxie
        ...
        if ariflirtcounter <= 1:
            text  "{color=#00000000}Visit the market place and {p}flirt with the pink mare a{p} few times.{/color}":
                xalign 0.91
                yalign 0.69
        ...
        if auroravisit1 == 1:
            ...
            text  "{color=#00000000}Complete Bakery, Library, {p}and have a total of 20 {p}days in-game.{/color}":
                xalign 0.91
                yalign 0.95
label inventorymenuday:
    ...
    if worldmap == 1:
        ...
        show bg pgworldmapnight with dissolve
    if inv1sttime == 0:
        $ inv1sttime = 1
        "This is the bag Moxie gave me. Well, she called it a 'satchel', I don't know what the difference is."
        "Pretty sure she made it herself."
        "It's certainly girly, but it should be able to carry a bunch of stuff."
        "Here's what I've got now:"
        pass
    menu inventorymenuday2:
        "Moxie's Satchel:":
            jump inventorymenuday2
        "[chocolates] Chocolates" if chocolates >= 1:
            jump inventorymenuday2
        "[roses] Roses" if roses >= 1:
            jump inventorymenuday2
        "Castle Permit" if libraryvisit3 == 1:
            jump inventorymenuday2
        "Augusta's Gallery Key" if artgallery == 1:
            jump inventorymenuday2
        "Gallery Pass" if gallerydpass == 1 or galleryypass == 1:
            jump inventorymenuday2
