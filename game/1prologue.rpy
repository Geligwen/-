...
label prologue:
    label prologueday1:
        ...
        "Она выглядела как голубое гуманоидное существо, напоминающее антропоморфную лошадь или пони. Она была полностью обнажена, с розоватыми ареолами и сосками, выступающими сквозь блестящий мех на её груди."
