label castle:
    ...
    menu castlemenu:
        ...
        "Meet with the Principal through the Mirror Portal" if pauroras == 0 and dawnvisit >= 3:
            $ pauroras = 1
            ...
            jump principalaurora
        "Sauna Trip! (End the Game)" if spaday == 1:
            menu:
                "Are you ready to end your journey?"
                "Yes":
                    jump spaday
                "Not yet, there are ponies that need fucking!":
                    jump castlemenu
        "Leave":
            jump city

label aurora:
    scene bg castlethrone with dissolve
    show aurorab dress
    show aurora happy
    with dissolve
    ...
    menu auroramenu:
            ...
            if auroravisit1 == 1:
                menu:
                    "Missionary":
                        ...
                        play sound cum
                        show aurora missionary4 with dissolve
                        ...
                        aurora "Ahhh… Yes…. The way it grinds against every inch of my pussy with each movement, your cock is truly exquisite."
                        "*Thrust*, *Thrust*… *Thrust* With each motion I slide smoothly out and then sink deeply inside her, as my cock presses deep within her I can feel her tighten around my shaft."
                        show aurora missionary5 with dissolve
                        ...
                        show aurora missionarybonus
                        mc "Wait, what?"
                        aurora "Oh, uh, that one just kinda slipped out!"
                        play music sex1 fadein 1.0
                        ...
                        play sound cum
                        show aurora missionary6 with cum
                        play sound cum
                        show aurora missionary6 with cum
                        ...
                        show aurora missionary7 with dissolve
                        ...
                        show aurora missionary8 with dissolve
        ...
        "Talk" if auroratalk == 0:
            ...
            menu:
                ...
                "Ask her to go easy on Lily since she's overworked." if fr == 0:
    ...
    label auroravisit1:
        ...
        "Her eyes are tightly d, and moans freely escape her mouth, as she pounds her pussy with the stallion dildo."
        ...
        show aurora missionary2 with dissolve
        show aurora missionary1 with dissolve
        ...
        aurora "You’re early."
        scene bg castlelivingroom with dissolve
        "She s her legs and sits upright. I feel compelled to walk down the stairs. Notably, she watches me the entire time, fortunately with a relaxed expression."
        show aurorab
        show aurora happy
        with dissolve
        aurora "I did not expect to get interrupted during my morning ‘me’ time, but I know you can keep a secret."
        play sound magic2
        show aurora laughing with moxiespell
        ...
        show aurora horny with dissolve
        ...
        #"With a suitable opportunity I spread her legs wide apart and she responds by rotating to face me and sinking back into the comfortable sofa."
        #"As I positioned myself between her thick thighs of which my hands grazed up and down, stroking her soft fur as my fingers moved up to her pelvis."
        ...
        show aurora embarrassed with dissolve
        ...
        "*Thrust*, *Thrust*… *Thrust* With each motion I slide smoothly out and then sink inside her, as my cock presses deep within her I can feel her tighten around my shaft."
        show aurora missionary5 with dissolve
        aurora "Mmmm, ahhh! You nudge my clit slightly at the peak of each thrust, fuck that’s good."
        ...
        show aurora missionary9 with dissolve
        ...
        show aurora missionary10 with dissolve
        play sound cum
        ...
        play sound cum
        show aurora missionary10 with cum
        play sound cum
        show aurora missionary10 with cum
        stop ambience fadeout 3.0
...
label selene:
    if selenevisit1 == 0:
        ...
        menu selenemenu:
            "Talk" if selenetalk == 0:
                menu:
                    "What kind of dreams are most common?":
                        ...
                        mc "Nah, not at all."
                        show selene happy with dissolve
                    "Have any interesting stories from your work?":
                    ...
                    "Craziest bucket list story?":
                        ...
                        show selene embarrassed with dissolve
            ...
            "Sex" if selenesex == 0:
                menu:
                    "Blowjob into Cowgirl":
                        ...
                        show selene cowgirl6 with moxiespell
                        ...
                        play sound magic2
                        show selene cowgirl5 with moxiespell
                        ...
                        show selene satisfied with moxiespell
                    ...
                    "Threesome?" if fr == 1:
                        ...
                        play sound cum
                        show auroraselene threesome5 with cum
                        play sound cum
                        show auroraselene threesome5 with cum
                        ...
                        play sound cum
                        show auroraselene threesome6 with cum
                        play sound cum
                        show auroraselene threesome6 with cum
                        stop ambience fadeout 3.0
                        stop music fadeout 3.0
    ...
    label selenevisit:
        ...
        scene bg black with dissolve
        "…"
        show bg castlehallnight with dissolve
        ...
        menu:
            "It’s okay, I’m ready to perform, just lay down on the bed.":
                show selene laughing with dissolve
            ...
            "What do you need of me, Princess Selene?":
                show selene neutral with dissolve
                selene "Recently, all of your friends have been having nightmares."
                selene "I need your help to investigate the cause of these nightmares."
        ...
        menu:
            "Can’t you use your magic to get rid of the nightmares, or something?":
                show selene neutral with dissolve
        ...
        if farmvisit2 == 1 and boutiquevisit2 == 1:
        ...
        menu:
            ...
            "Can you make Moxie your student?":
                show selene laughing with dissolve
        ...
        show bg stadium2 with dissolve
        show rikub
        show riku neutral
        with dissolve
        ...
        play music sadpiano fadein 3.0
        show riku shy with dissolve
        riku "Sometimes, yeah."
        show riku sad with dissolve
        ...
        menu:
            "Spend more time with your new friends and get 'over' your past.":
                show riku shy with dissolve
            ...
            "Get back into athletics in different ways.":
                show riku shy with dissolve
            ...
            "Learn to love yourself and your decisions.":
                show riku shy with dissolve
        ...
        show selene happy at right with dissolve
        ...
        show bg white with dissolve
        pause 0.5
        show bg castlebalcony with dissolve
        ...
        show selene neutral at right with dissolve
        ...
        show ruby embarrassed at left with hpunch
        "When Ruby turns around, this causes her to jump with fright."
        scene bg castlebalcony with dissolve
        show selene surprised with dissolve
        mc "Should I step in?"
        ...
        show mannequin at left with dissolve
        "I look back to Ruby who curiously inspects the mannequin from every angle."
        show mannequin2 with dissolve:
            xpos 100
            ypos 40
        show mannequin3 with dissolve:
            xpos 400
            ypos 40
        show mannequin4 with dissolve:
            xpos 800
            ypos 40
        ...
        menu:
            "Are you too stressed from being overworked and the work is haunting you?":
                show ruby sad with dissolve
                ruby "Too stressed? No darling, I love my work."
                ruby "It’s just these spooky mannequins started moving on their own!"
            "Are these figures representations of the people that judge you for your work?":
                show ruby sad with dissolve
        ...
        menu:
            "Ghosts aren’t real, you don’t have to worry about it.":
                show ruby sad with dissolve
            ...
            "These are just stupid mannequins; they can’t hurt you.":
                show ruby sad with dissolve
        ...
        show butters robed with dissolve:
            xpos -100
            ypos 0
        ...
        hide butters robed with hpunch
        ...
        show bg moxieperformance with dissolve
        play music triads
        ...
        show bg moxieperformance2 with dissolve
        ...
        show bg moxieperformance3 with dissolve
        ...
        show bg moxiebackstage with dissolve
        ...
        scene bg moxiebackstage with dissolve
        show butters robed with dissolve
        ...
        hide butters with moveoutright
        ...
        scene bg black with dissolve
        show bg white with dissolve
        show bg libraryupstairsgs with dissolve
        ...
        hide penelopexmoxiegs with dissolve
        ...
        show bg peneloperoomgs with dissolve
        show penelope neutralgs with dissolve
        ...
        menu:
            "I’m here to work at the library.":
                pass
            "I’m hunting for an evil wizard that is giving you nightmares.":
                pass
        show penelope angrygs with dissolve
        ...
        mc "Yeah, but…"
        show penelope closeshygs with dissolve
        ...
        show penelope closesadgs with dissolve
        ...
        show penelope closeangrygs with dissolve
        ...
        show penelope closeshockedgs with dissolve
        ...
        show penelope closeneutralgs with dissolve
        ...
        show penelope satisfiedgs with dissolve
        ...
        show penelope happygs with dissolve
        ...
        show penelope shocked at left with dissolve
        ...
        show bg farm2nightrain with dissolve
        ...
        show bg farmnightrain with dissolve
        ...
        show blossom neutral at left with dissolve
        if farmvisit1 == 0:
        ...
        show honeycrisp ncangry at right with dissolve
        if farmvisit1 == 0:
        ...
        scene bg farmzombies with dissolve
        ...
        show honeycrisp ncneutral at left with dissolve
        ...
        show blossom shocked at right with dissolve
        ...
        show blossom embarrassed at right with dissolve
        ...
        menu:
            "That’ll be because I’m not from around here.":
                selene "That’s the impression I got, you have no frame of reference when everyone is new and strange to you."
            "I have to treat you as an equal if I want to become your lover":
                show selene laughing with dissolve
        ...
        mc "Ah- you’re…"
        show butters robed at right with dissolve
        unknown "Uuu, you two are persistent."
        show selene neutral at left with dissolve:
        ...
        play sound magic2
        show butters surprised with cum
        ...
        "…"
        show bg selenebedroom with dissolve
        play ambience ambiencenight fadein 15.0
        ...
        menu:
            "What is your sex life like?":
                ...
                jump selenevisit1choice1
            "What is Aurora’s sex life like?":
                show selene laughing with dissolve
        ...
        if augustavisit > 1 and auroravisit1 == 1:
        ...
        show selene cowgirl7 with moxiespell
        "With an effortless, quick glow of her horn, I can feel my balls tingling, the heightened sensitivity of my refractory period disappears, and my erection returns."
        ...
        if livingwithmoxie == 1:
            ...
            jump morning
label principalaurora:

    play music aurora fadein 5.0
    show bg humanoffice with dissolve
    "Stepping out of the t, I see the principal is at her desk performing some paperwork, but within seconds of revealing myself her attention is completely on me."
    ...
    show principalaurora horny with dissolve
    paurora "Mmm… I think I have a lady boner that requires taking are of too. *Giggles*"
    paurora "Think you can help me, big boy?"
    "She's such a damn cougar, but I love it."
    "She s the distance wraps her slender fingers around my growing cock and gently starts to jack me off into a full throbbing erection."
    mc "*Twitch, throb*"
    ...
    "As I move my hips, my cock slides back and forth with ease and depth. The deepness of each thrust hitting the right spots within Aurora to make her squeal with delight, even at this slower pace."
    ...
    "And the increase the friction and tightness of her human pussy immensely increases the pleasure I'm used to."
    ...
    play sound cum
    show principalaurora sex4 with cum
    "The cougar's pussy has me beat, I can't hold back as I relentlessly unload my cum deep her."
    play sound cum
    show principalaurora sex4 with cum
    play sound cum
    show principalaurora sex4 with cum
