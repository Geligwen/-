label city:
    ...
    label musicstudio:
        if musicstudio == 0 and farmvisit3 == 1 and boutiquevisit3 == 1 and spavisit == 1:
            ...
            melody "It's also next to a brothel, did you notice that Blossom? I bet that gets some good evening business."
            show blossom shocked with dissolve
            ...
            mc "Another brothel huh? I didn't realize it was so common place."
            show melody fufufu with dissolve:
            ...
            show blossom happy with dissolve
            show melody happy with dissolve
            claire "Now I've got some monies, I'm going to order some new equipment, do you girls want to help me?"
            ...
            melody "Here, take a spare keycard to get in, just in case."
            ...
            "The front door requires a student keycard. The only way to get in would be to befriend a local student, I guess."
            jump citymenu
                ...
                menu:
                    ...
                    menu musicgalleryp2:
                        ...
                        "Lily's Theme":
                            play music lily
                            menu:
                                "Currently listening to Lily's theme."
                                "Stop":
                                    stop music fadeout 1.0
                                    jump musicgalleryp2
                        "Melody's Theme":
                    ...
                    menu musicgalleryp7:
                        ...
                        "Church Theme":
                            play music church
                            menu:
                                "Currently listening to Tranquil - Edwardch93"
                                "Stop":
                                    stop music fadeout 1.0
                                    jump musicgalleryp7
                        "<- Page 6":
        ...
        label melodylaptop:
            ...
            mc "I already know that dummie, I wouldn't have given you the money otherwise."
...
label nightcity:
    ...
    menu:
        ...
        "Music Studio":
            label musicstudioncm:
                pass
            if musicstudio == 0:
                "I can't get in without a keycard."
                jump nightcitymenu
            $ musicstudionight = 1
            scene bg musicstudio with dissolve
    ...
    label nightclub:
        ...
        label agathasoniathreesome:
            ...
            "Ah- I find the entrance and slide into her slick warm insides with ease, grabbing onto her ass to stabilise myself before I begin to pound away."
            agatha "Oohh, oooohhhh! You really were a grow’er, not a show’er! Ahhaahh…"
            mc "H-Hey! Das rude, I’ve got a big dick!"
            agatha "Ahh-ahh-ahhhh! That’s what I just said, dummie!"
        ...
        label agathasoniathreesome2:
                ...
                "Sonia occasionally squeezing and spreading Agi’s amazing ass, while Ari rubs Sonia’s puffy pussy."
