label dawntalksex:
    ...
    label dawnsex:
        ...
        label dawnblowjob:
            ...
            "Simultaneously she takes to time to adjust herself so her breasts are brazenly pushed against my shaft, where she continues to fondle her breasts enticingly now they’re in perfect view."
        ...
        label dawnrcg:
            ...
            play sound cum
            show dawn sex5 with cum
            "Dawn’s almost gives way as she feels the first torrent of cum unloads inside of her, the warm thick cum filling her womb and vagina."
            play sound cum
            show dawn sex5 with cum
            play sound cum
            show dawn sex5 with cum
...
label dawnvisits:
    label dawnvisit2:
        ...
        menu:
            ...
            "What do you do in your spare time?" if dawnv2c14 == 0:
                ...
                show dawn dresshappy with dissolve
                dawn "Every note has a special spell placed on it. This spell unlike most is permanent, and only few know how to cast it."
    ...
    label dawnvisit3:
        ...
        paurora "So, you're not another creature in disguise, like Dawn? I’ve only encountered Dawn use these portals."
        ...
        "Also, unlike a mare, a human’s pussy doesn’t get as wet. Perhaps it’s because a mare need more lubricants to handle a stallion’s cock."
        ...
        "She flinches and quivers under my grasp, my cock plunges repeatedly into her deepest and most sensitive spots."
        ...
        show dawn humanhappy with dissolve
        dawn "If you could tell me about some interesting books and technologys, that would be great."
        dawn "Additionally, while I appreciate you’re not an expert, I’d like to know about the potential history and past of this universe."
        mc "Alright, try me."
        hide dawn with dissolve
        ...
        paurora "Welcome back, and just before closing time, you had me worried for a few moments."
        show dawn humanhappy with dissolve:
            xpos 250
            ypos 20
        ...
        play sound cum
        show dawn sex5 with cum
        "Dawn almost gives way as she feels the first torrent of cum unloads inside of her, the warm thick cum filling her womb and vagina."
        play sound cum
        show dawn sex5 with cum
        play sound cum
        show dawn sex5 with cum
    ...
    label dawnvisit5:
        ...
        show dawn2 angry with dissolve
        dawn2 "Oh sheesh, the door at time like this?"
        hide dawn2 with dissolve
        ...
        show dawn2 neutral with dissolve
        dawn2 "Actually, I think I’ll pass. I got carried away earlier, but I think it’s be too strange to sleep with [playername] again knowing all of this."
        ...
        dawn "Although that might be the more prudish side of me speaking, a side that become prominent in my time at the colourful human universe."
