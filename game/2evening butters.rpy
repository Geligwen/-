    ...
    label eveningbutterssex:
        menu:
            ...
            "Наездница наоборот" if butterschocolates == 1:
                ...
                "Учитывая её невинность, легко заыть про естественные чары суккуба Баттерс, которые затуманивают мой разум and stiffen my cock, enhancing each and every sensation."
