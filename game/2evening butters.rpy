label eveningbutters:
    ...
    label eveningbutters1:
        ...
        if livingwithbutters == 1:
            ...
            if rand == 1:
                ...
                show butters dresshappy with dissolve
                butters "Добрый вечер, что привело тебя в такое время?"
                jump eveningbuttersmenu
        label eveningbutterssuccmenu:
            menu:
                "Go Outside":
                    show butters succsurprised with dissolve
                    butters "Что? Стой, не уходи!"
                    if fr == 1:
                        jump prefinalworldmapnight
                    jump preworldmapnight
                "Talk" if succbutterstalks == 0:
                    show butters succsurprised with dissolve
                    butters "Ты просто хочешь поговорить со мной? Я надеялась немного на другое, ну окей."
                    jump eveningbutterssucctalk
                "Секс":
                    show butters closesucchorny with dissolve
                    "Ты спрашиваешь СуккуБаттерс, не хочет ли она заняться кое-чем развратным, она охотно кивнула и набросилась на тебя."
        ...
        label eveningbuttersmenu:
            menu:
                ...
                "Подарок" if chocolates >= 1 or roses >= 1:
                    menu:
                        "Шоколадки" if butterschocolates == 0 and chocolates >= 1:
                            $ butterschocolates = 1
                            $ chocolates -= 1
                            $ buttersgifts += 1
                    ...
                    menu:
                        "Конечно.":
                            ...
                            if livingwithbuttersfirsttime == 0:
                                ...
                                moxie "В конце концов её дом всего в нескольких шагах отсюда, ты можешь навестить меня в любое время, и Хей! может быть это я тебя навещу!"
                                ...
                                if fr == 1:
                                    ...
                                    show moxie happyneutral with dissolve
                                moxie "Конечно! Я всегда хотела, чтобы ты перерос это местечко."
                                if fr == 1:
                                    show moxie wlaughing with dissolve
                                else:
                                    show moxie laughing with dissolve
                            ...
                            moxie "Хотяя, ухммм..."
                                ...
                                play ambience sex
                                moxie "Оо да, да, даа! Я навсегда останусь твоей сучкой, ааХХ ХааХ!"
                                play sound cum
                                if fr == 1:
                                ...
                                scene bg black with dissolve
                                "..."
                                "Мы с Мокси бурно и грубо трахались до глубокой ночи, пока мы оба не свалились от изнеможения."
                                stop music fadeout 3.0
    ...
    label eveningbutterssex:
        menu:
            "Поза наездницы":
                ...
                "Она искусно владела своим телом, в порыве страсти быстрыми и напористыми толчками она скакала на мне, скользя по моему члену от кончика до самого основания."
                "В мгновение ока, my cock is feeling tight and full, almost ready to burst into Butters's dribbling cunt."
                "Она погладила меня по щеке и понимающе улыбнулась."
                butters "Ничего страшного, если ты кончишь слишком быстро, в этом моя суккубья натура, она всегда заставит тебя сделать это, ты всегда будешь кончать для меня."
                show butters cowgirl3 with dissolve
                butters "Ты готов, малыш? Моя матка ждёт этого..."
                play sound cum
            ...
            "Наездница наоборот" if butterschocolates == 1:
                scene bg buttersbednight with dissolve
                play music sex1 fadein 3.0
                "Мы неторопливо заходим в спальню. Она быстро раздевается, пока я лежу на кровати."
                show butters closehorny with dissolve
                "Баттерс оглянулась вокруг и слегка покраснела, увидев меня лежащего на спине. Она подходит к кровати и садится на неё."
                "Одной рукой, глядя на меня с похотливой ухмылкой, она начала поглаживать мой член."
                butters "Охх, так бысто возбудился, да ты уже готов..."
                ...
                "Она сладостно промычала и поцеловала головку моего члена, после чего оседлала меня одним плавным движением, медленно скользя по моему стержню."
                "Когда я полностью вошёл в неё, я раздвинул пальцами её набухшие половые губки и увидел как сильно уже намокла её киска."
                "Учитывая невинный образ Баттерс, легко забыть про её естественные чары суккуба, которые затуманивают твой разум и, усиливая каждое малейшее ощущение заставляют крепко твердеть твой член."
            ...
            "Мессионерская позза (с оплодотворением)" if buttersmissionaryunlock == 1 and butterspregnant == 0:
                ...
                "Одной рукой я массирую ее большие мягкие груди, а другой стимулирую свою усиливающуюся эрекцию."
                "Наконец полностью эрегерованный и готовый, я выпрямляюсь не сводя глаз с моего бесценного подарка."
                ...
                "Глядя на её румяные от желания щёчки, я ухмыляюсь и начинаю тереться головкой члена о её вульву."
                play sound cum
                ...
                "Я глубоко проскальзываю в свою возлюбленную, нити липкой влаги связывают нас, когда мой член проникает в её самые сокровенные места."
                ...
                play ambience sex fadein 3.0
                "Мы стонем от удовольствия, когда я  I slide back out, and push back deeply into the hilt of her inviting insides."
    ...
    label buttersimpregintro:
        ...
        show butters happy with dissolve
        butters "I would be completely okay serving you as maid, you just need to say the word! I’m yours, in body and mind!"
        ...
        label buttersimpregmissionary:
            ...
            if buttersimpregintro == 1:
                ...
                "She looks beautiful right now. A cast of light shimmers from the setting sun, through the mountains, and peers through the window to illuminate her body."
            "All this beauty, and I’m lucky enough for her to offer it to me."
            butters "Hah... [playername]..."
            "She’s so wet, she’s clearly in a very lustful mood. Her legs are already splayed open as she eagerly awaits penetration."
            "I approach the bed, drinking in every detail of her beautiful form."
            ...
            "She’s dripping wet, causing my tip to glisten in the glow of the sun. Having teased her enough, I line up with her entrance and push inwards."
            "I slide myself deeply into my lover, strings of sticky wetness connect us as my shaft pushes into the deepest reaches of her nether."
            butters "Aahhh, aahhh… It seems the potion has made me a little sensitive, but don’t worry, it feels even better than usual."
            "The walls of her pussy clamp down around my member, enveloping me in warmth and squeezing pleasantly around every nerve ending."
            play ambience sex fadein 3.0
        ...
        label buttersnonimpregmissionary:
            ...
            if buttersimpregintro == 1:
                ...
                butters "Ooohh, I usually try to avoid sex before dinner, but I’m so horny lately..."
            mc "It must be that material instinct finally kicking in now that you’re cured."
            show butters horny with dissolve
    ...
    label buttersimpregpaizuri:
        ...
        menu:
            ...
            "It's too early in the morning for sexy times.":
                mc "Can’t you just milk it yourself? You’re being somewhat melodramatic by asking me."
                show butters milkyneutral with dissolve
