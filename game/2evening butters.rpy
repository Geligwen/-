    ...
    label eveningbutterssex:
        menu:
            ...
            "Наездница наоборот" if butterschocolates == 1:
                ...
                "Она сладостно промычала и поцеловала головку моего члена, после чего оседлала меня одним плавным движением, медленно скользя по моей рукояти."
                "Когда мой член полностью вошёл в неё, я раздвинул пальцами её набухшие половые губки и увидел насколько намокла её киска."
                "Учитывая её невинность, легко забыть про естественные чары суккуба Баттерс, которые затуманивают мой разум and stiffen my cock, enhancing each and every sensation."
