    ...
    label eveningbutterssex:
        menu:
            ...
            "Наездница наоборот" if butterschocolates == 1:
                ...
                "Она начинает водить своими бёдрами взад и вперёд, время от времени толкаясь вверх и вниз, она буквально объезжала меня, как ездового скакуна."
                butters "Аххх, я хочу растянуть это удовольствие..."
                "В ответ я двигаю бёдрами в так её движений, causing her ass to thwap against with the force of us both in our rut."
                ...
                "She orgasms, perhaps not her first, но она замедлилась, чтобы я не кончил, пока она полностью не наиграется мной."
