        ...
        menu marketmenu2:
            ...
            "Gifts":
                if dawnltr == 5:
                    ...
                    "In a mere moment the tip of my erection is pressed up against her lustful virginal pussy. Pushing forward, I feel her nether lips part around my girth."
                    ...
                    "The feeling of her insides become even more pleasurable overtime as they become warmer and wetter. The point of our connection squelching with the lewd sounds of her juices as her tight lips grip around my shaft."
            ...
            "Muffins":
                ...
                ci "Hey, want some muffins?"
                menu cimuffinmenu:
                    "Blueberry – (Reverse Cowgirl) – 50 Monies" if mhag == 0:
                        $ monies -= 50
                        jump cindyrcg
                    "Raisin – (Lingerie Leg Up Missionary) – 75 Monies" if mhag == 0 and cindyrcg == 1:
                        $ monies -= 67
                        jump cindylum
                    "Blueberry – (Reverse Cowgirl) – 45 Monies" if mhag == 1:
                        $ monies -= 45
                        jump cindyrcg
                    "Raisin – (Lingerie Leg Up Missionary) – 67 Monies" if mhag == 1 and cindyrcg == 1:
                        $ monies -= 67
                        jump cindylum
                    "Back":
                        ci "Awh, later!"
